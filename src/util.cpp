...
int nAnonymizeSatoshiAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Satoshi
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Satoshi
    // Mac: ~/Library/Application Support/Satoshi
    // Unix: ~/.Satoshi
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Satoshi";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Satoshi.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Satoshid.pid"));
