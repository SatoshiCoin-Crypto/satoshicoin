...
private slots:
    ...
    QString BuySATC(QString OrderType, double Quantity, double Rate);
    QString SellSATC(QString OrderType, double Quantity, double Rate);
